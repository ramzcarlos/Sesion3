...
public class TestPizzeriaEjercicio1 {
	...
	public void verificarOpcionVeganaVerdadera() {
		...
		System.out.println("actual opc: "+actualResult);
		System.out.println("expect opc: "+expectedResult);
		Assert.assertEquals(actualResult, expectedResult);
	}
	...
	public void verificarOpcionVegAlPreguntarOpcionVeganaTrue() {
		...
		Common.redirectStdOutput(stdInputPath);
	...
	public void verificarListaIngredientesVegetarianos() throws
		...
		//String actualResult = Common.readFileContents(stdOutputPath);
		String actualResult =  "Selecciona 3 ingredientes de la siguiente lista: \n"+ "[a] Pimiento \n"
				+ "[b] Hongos \n"
				+ "[c] Espinaca \n"
				+ "[o] Ninguno \n\n";
